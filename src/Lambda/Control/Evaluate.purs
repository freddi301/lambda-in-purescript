...
reify :: forall reference decoration . Eq reference => reference -> Ast reference decoration -> Ast reference decoration -> Ast reference decoration
...
reifyEvaluate :: forall reference decoration . Eq reference => Ast reference decoration -> Ast reference decoration
...
reifyEvaluateSymbolic :: forall reference decoration . Eq reference =>
...
extractReference :: forall reference variation . Symbol reference variation -> reference
...
-- | `scope` current scope
-- | `term` the ast
collectFreeReferences :: forall reference decoration . Ord reference =>
